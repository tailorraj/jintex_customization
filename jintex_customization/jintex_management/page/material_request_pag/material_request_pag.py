...
@frappe.whitelist()
def get_items(product_id=None, item_group=None, category=None, supplier=None, offset=0, limit=15):
    ...
    return frappe.db.sql("""
        ...
        """ % {"bangalore_warehouse":bangalore_warehouse, "cond":cond, "offset":offset, "limit": limit},as_dict = True)
